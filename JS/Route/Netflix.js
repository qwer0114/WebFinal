...
const getMovies = async () => {
  const api = await fetch(
    `${API_URL}discover/movie/?api_key=${API_Key}&page=1&sort_by=popularity.desc&watch_region=KR&with_watch_providers=8&language=ko-KR`
  );
...
const getKRmovies = async () => {
  const api = await fetch(
    `${API_URL}discover/movie/?api_key=${API_Key}&page=1&sort_by=popularity.desc&watch_region=KR&with_origin_country=KR&with_original_language=ko&with_watch_providers=8&language=ko-KR`
  );
  const json = await api.json();
...
const action = async () => {
  const api = await fetch(
    `${API_URL}discover/movie/?api_key=${API_Key}&page=1&sort_by=popularity.desc&watch_region=KR&with_watch_providers=8&language=ko-KR&with_genres=28`
  );
  const json = await api.json();
...
const comedy = async () => {
  const api = await fetch(
    `${API_URL}discover/movie/?api_key=${API_Key}&page=1&sort_by=popularity.desc&watch_region=KR&with_watch_providers=8&language=ko-KR&with_genres=35`
  );
  const json = await api.json();
...
const horror = async () => {
  const api = await fetch(
    `${API_URL}discover/movie/?api_key=${API_Key}&page=1&sort_by=popularity.desc&watch_region=KR&with_watch_providers=8&language=ko-KR&with_genres=27`
  );
  const json = await api.json();
...
const crime = async () => {
  const api = await fetch(
    `${API_URL}discover/movie/?api_key=${API_Key}&page=1&sort_by=popularity.desc&watch_region=KR&with_watch_providers=8&language=ko-KR&with_genres=80`
  );
  const json = await api.json();
...
const fantasy = async () => {
  const api = await fetch(
    `${API_URL}discover/movie/?api_key=${API_Key}&page=1&sort_by=popularity.desc&watch_region=KR&with_watch_providers=8&language=ko-KR&with_genres=14`
  );
  const json = await api.json();
...
const animation = async () => {
  const api = await fetch(
    `${API_URL}discover/movie/?api_key=${API_Key}&page=1&sort_by=popularity.desc&watch_region=KR&with_watch_providers=8&language=ko-KR&with_genres=16`
  );
  const json = await api.json();
